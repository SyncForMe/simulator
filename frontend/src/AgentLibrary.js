                          ...
                          >
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-500">{category.agents.length} agents</div>
                              </div>
                            </div>
                            <button
                              type="button"
                            ...
                            <div className="p-4 pt-0 border-t border-gray-100">
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                {category.agents.map((agent) => (
                                  <div key={agent.id} className="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-sm transition-all relative">
                                    ...
                                    <div className="flex items-start space-x-3">
                                      <OptimizedAvatar 
                                        src={agent.avatar} 
                                        alt={agent.name}
                                        className="w-10 h-10 rounded-full object-cover flex-shrink-0 agent-avatar"
                                      />
