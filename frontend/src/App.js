          ...
          >
            ...
            <div className="py-2">
              ...
              <button
                ...
                onClick={handleMenuClick(null, 'Profile settings coming soon!')}
              >
              ...
              <button
                className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center space-x-3 transition-colors"
                onClick={handleMenuClick(null, 'Preferences coming soon!')}
              >
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="border-t border-gray-100 mt-2 pt-2">
                ...
                <button
                  className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center space-x-3 transition-colors"
                  onClick={handleMenuClick(null, 'Help & Documentation coming soon!')}
                >
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
